        ...
        <div>
            <div className="flex px-2 mt-6">
                <div className="border w-1/2 mr-2">
                    ...
                    <div className="text-gray-300 font-mono ml-3 mt-2" style={{
                    ...
                    <div className="text-gray-300 font-mono text-sm ml-3 mt-4 mb-4">
                ...
                <div className="border w-1/2">
                    ...
                    <div className="text-gray-300 font-mono text-sm ml-3 mt-9 mb-4">
